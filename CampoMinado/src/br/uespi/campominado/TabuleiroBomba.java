...
public class TabuleiroBomba extends Tabuleiro {
    ...
    public void numeraBombaEsquerda(int bx, int by) {
        ...
        if (bx - 1 > 0 && bx - 1 <= tabuleiro.length) {
            String e = this.tabuleiro[bx - 1][by];//E
            if (e != "@") {
                String value = "0";
                if (e != " ") {
                    value = e;
                }
                this.tabuleiro[bx - 1][by] = Integer.toString(Integer.parseInt(value) + 1);
            }
        }
    }
    ...
    public void numeraBombaDireita(int bx, int by) {
        if (bx + 1 > 0 && bx + 1 < tabuleiro.length) {
            String d = this.tabuleiro[bx + 1][by];//D
            if (d != "@") {
                String value = "0";
                if (d != " ") {
                    value = d;
    ...
    public void numeraBombaTopoEsquerda(int bx, int by) {
        ...
        //topo
        if (bx - 1 > 0 && bx - 1 < tabuleiro.length && by - 1 > 0 && by - 1 < tabuleiro.length) {
            String te = this.tabuleiro[bx - 1][by - 1];//TE
            if (te != "@") {
                String value = "0";
                if (te != " ") {
                    value = te;
                }
                this.tabuleiro[bx - 1][by - 1] = Integer.toString(Integer.parseInt(value) + 1);
            }
        }
    }
    ...
    public void numeraBombaTopoMeio(int bx, int by) {
        ...
        if (by - 1 > 0 && by - 1 < tabuleiro.length) {
            String tm = this.tabuleiro[bx][by - 1];//TM
            if (tm != "@") {
                String value = "0";
                if (tm != " ") {
                    value = tm;
                }
                this.tabuleiro[bx][by - 1] = Integer.toString(Integer.parseInt(value) + 1);
            }
        }
    }
    ...
    public void numeraBombaTopoDireita(int bx, int by) {
        ...
        if (bx + 1 > 0 && bx + 1 < tabuleiro.length && by - 1 > 0 && by - 1 < tabuleiro.length) {
            String td = this.tabuleiro[bx + 1][by - 1];//TD  
            if (td != "@") {
                String value = "0";
                if (td != " ") {
                    value = td;
    ...
    public void numeraBombaBaixoEsquerda(int bx, int by) {
        //rodapé
        if (bx - 1 > 0 && bx - 1 < tabuleiro.length && by + 1 > 0 && by + 1 < tabuleiro.length) {
            String be = this.tabuleiro[bx - 1][by + 1];//BE
            if (be != "@") {
                String value = "0";
                if (be != " ") {
                    value = be;
    ...
    public void numeraBombaBaixoMeio(int bx, int by) {
        if (by + 1 >= 0 && by + 1 < tabuleiro.length) {
            String bm = this.tabuleiro[bx][by + 1];//BM
            if (bm != "@") {
                String value = "0";
                if (bm != " ") {
                    value = bm;
    ...
    public void numeraBombaBaixoDireita(int bx, int by) {
        if (bx + 1 > 0 && bx + 1 < tabuleiro.length && by + 1 > 0 && by + 1 < tabuleiro.length) {
            String bd = this.tabuleiro[bx + 1][by + 1];//BD
            if (bd != "@") {
                String value = "0";
                if (bd != " ") {
                    value = bd;
